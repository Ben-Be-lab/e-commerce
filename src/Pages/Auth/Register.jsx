    ...
    <div className="min-h-[85vh] flex items-center justify-center bg-gray-50 px-4 py-20">
      <div className="w-full max-w-md bg-white p-10 md:p-12 rounded-[3rem] shadow-2xl shadow-black/5">
        ...
        <form className="space-y-4">
          ...
          <button className="w-full bg-emerald-600 text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-black transition-all shadow-lg active:scale-95 mt-2">
            Create Account
          </button>
        </form>
